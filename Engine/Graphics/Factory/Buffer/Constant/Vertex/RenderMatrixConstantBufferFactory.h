...
namespace Engine
{
	namespace Graphics
	{
		...
		{
			/**
			 * @brief 렌더 행렬 상수 버퍼 팩토리 클래스 : 상수 버퍼 팩토리 상속
			 * @date 2024-10-18
			 * @class
			 * 렌더 행렬 상수 버퍼를 생성하는 팩토리 클래스
			 */
			class RenderMatrixConstantBufferFactory : public ConstantBufferFactory
			{
			public: // ==== [상수 버퍼 생성(상수 버퍼 팩토리) 재정의] ====
				/**
				 * @brief 상수 버퍼 생성
